    ...
    if (!t.isInit) {
        ...
        t.Popup = function() {
            ...
            return i.prototype.init = function(i) {
                ...
                this.options.pushdown ? (this.wrapper = r.call(this, '<div class="wpcc-pushdown-wrap">' + s + "</div>"), this.wrapper.style.display = "", this.element = this.wrapper.firstChild, this.element.style.display = "none", e.addClass(this.element, "wpcc-invisible")) : (this.wrapper = null, this.element = r.call(this, s)),
